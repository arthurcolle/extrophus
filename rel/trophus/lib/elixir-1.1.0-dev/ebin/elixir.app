{application,elixir,
             [{description,"elixir"},
              {vsn,"1.1.0-dev"},
              {modules,['Elixir.Access','Elixir.Access.Any',
                        'Elixir.Access.Atom','Elixir.Access.HashDict',
                        'Elixir.Access.List','Elixir.Access.Map',
                        'Elixir.Agent','Elixir.Agent.Server',
                        ...
                        'Elixir.Kernel.Def','Elixir.Kernel.ErrorHandler',
